<div>
    ...
    <table class="min-w-full table-auto text-sm">
        @include('livewire.common.client')
        <tr class="border-b">
            <td colspan="2">
                <button wire:click.prevent="updateClient()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded" data-save="true">{{ __('Save') }}</button>
